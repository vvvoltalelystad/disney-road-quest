...
const AVATARS=[['mickey','Mickey Mouse','🐭'],['donald','Donald Duck','🦆'],['stitch','Stitch','👽'],['elsa','Elsa','❄️'],['buzz','Buzz Lightyear','👨‍🚀'],['jack','Jack Sparrow','🏴‍☠️'],['simba','Simba','🦁'],['remy','Remy','👨‍🍳'],['peter','Peter Pan','🧚‍♂️'],['taran','Taran','⚔️'],['wendy','Wendy Darling','👧'],['heihei','Heihei','🐔']];
