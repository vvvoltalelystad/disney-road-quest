...
function A(id){const map={hyperspace:'buzz',big_thunder:'taran',phantom:'stitch',pirates:'jack',tower:'stitch',star_tours:'buzz',small_world:'linguini',ratatouille:'remy',buzz:'buzz'};const targetId=map[id]||id;const x=AVATARS.find(v=>v[0]===targetId)||AVATARS[0];return{id:x[0],name:x[1],icon:x[2],power:x[3]}}
